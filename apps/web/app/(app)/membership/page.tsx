...
function MembershipPageSkeleton() {
  return (
    <div className="min-h-screen w-full bg-linear-to-br from-slate-50 via-white to-slate-100 p-4 md:p-8 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            {subscription ? (
              ...
              <Card className="border-primary/20 from-primary/5 to-primary/10 border-2 bg-linear-to-br shadow-lg">
                <CardHeader>
              ...
              <div className="space-y-4">
                ...
                {/* CTA Button */}
                <Card className="border-primary/20 from-primary/5 border-2 bg-linear-to-br to-transparent">
